        ...
        public function register($post_fields){
            ...
            if (!$has_errors):
                ...
                if ($attempted_attendees_num > $spots_left):
                    $has_errors=true;
                    $return_arr['success']=0;
                    $return_arr['msg']="You are attempting to register $attempted_attendees_num attendees for this ".strtolower(SRM_DEFAULT_NAME).", however there are only $spots_left spots remaining.";
                else:
