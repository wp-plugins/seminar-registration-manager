<div class="srm-seminars">
    <div class="srm-header">
        ...
        <?php endif; ?>
        <div class="srm-back-link"><a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=seminar-registration-manager">Back to All <?php echo ucwords(strtolower(SRM_DEFAULT_NAME)); ?>s</a></div>
    </div>
    <div class="srm-form">
        <?php
            if ($has_errors):
        ...
        <form action="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=<?php echo $_GET['page']; ?><?php if ($is_edit_mode): ?>&id=<?php echo $_GET['id']; ?><?php endif; ?>" method="post" enctype="multipart/form-data" id="add-edit-seminar-form" onsubmit="return srm_validate_form(this.id);">
            ...
            <fieldset>
                ...
                <?php
                    if ($is_edit_mode):
                ?>
                        <div class="center"><input type="submit" name="submit" value="Edit <?php echo ucwords(strtolower(SRM_DEFAULT_NAME)); ?>" /></div>
                <?php
                    else:
                ?>
                        <div class="center"><input type="submit" name="submit" value="Create <?php echo ucwords(strtolower(SRM_DEFAULT_NAME)); ?>" /></div>
                <?php
                    endif;
                ?>
            </fieldset>
