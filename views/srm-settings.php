    ...
    <div class="srm-form">
        ...
        <form action="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=<?php echo $_GET['page']; ?>" method="post" enctype="multipart/form-data" id="edit-settings-form" name="edit_settings_form" onsubmit="return srm_validate_form('edit-settings-form');">
            <fieldset>
                ...
                <div class="form-row">
                    <div class="left">Type of Event (for front-end display):</div>
                    <div class="right">
                        <input type="text" name="SRM_DEFAULT_NAME" id="srm-SRM_DEFAULT_NAME" value="<?php echo $plugin_values['SRM_DEFAULT_NAME']; ?>" /> (e.g. Seminar, Event, Workshop, etc. Use singular form)
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="left">Default Terms/Conditions Page:</div>
                    <div class="right">
                        <input type="text" name="SRM_DEFAULT_TERMS_PAGE" id="srm-SRM_DEFAULT_TERMS_PAGE" value="<?php echo $plugin_values['SRM_DEFAULT_TERMS_PAGE']; ?>" />
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row srm-hide srm-payment-credentials" id="srm-paypal_payments_pro">
                    ...
                    <div class="right">
                        <strong>API Username</strong> <input type="text" name="SRM_PAYPAL_PAYMENTS_PRO_USERNAME" id="srm-SRM_PAYPAL_PAYMENTS_PRO_USERNAME" value="<?php echo $plugin_values['SRM_PAYPAL_PAYMENTS_PRO_USERNAME']; ?>" />
                        <br />
                        <strong>API Password</strong> <input type="text" name="SRM_PAYPAL_PAYMENTS_PRO_PASSWORD" id="srm-SRM_PAYPAL_PAYMENTS_PRO_PASSWORD" value="<?php echo $plugin_values['SRM_PAYPAL_PAYMENTS_PRO_PASSWORD']; ?>" />
                        <br />
                        <strong>API Signature</strong> <input type="text" name="SRM_PAYPAL_PAYMENTS_PRO_SIGNATURE" id="srm-SRM+PAYPAL_PAYMENTS_PRO_SIGNATURE" value="<?php echo $plugin_values['SRM_PAYPAL_PAYMENTS_PRO_SIGNATURE']; ?>" />
                    </div>
                    <div class="clear"></div>
                </div>
            </fieldset>
