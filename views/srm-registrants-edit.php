...
?>
        <div class="srm-form">
            ...
            <form action="" method="post" id="srm-registration" onsubmit="return srm_validate_form(this.id);">
                <fieldset>
                    <legend><?php echo ucwords(strtolower(SRM_DEFAULT_NAME)); ?> Information</legend>
                    <div class="two-col-left">
                        <div class="form-row">
                            <div class="left"><?php echo ucwords(strtolower(SRM_DEFAULT_NAME)); ?>:</div>
                            <div class="right"><strong><?php echo $seminar_data['title']; ?></strong></div>
                            <div class="srm-clear"></div>
                        </div>
                        <div class="form-row">
                            <div class="left"><?php echo ucwords(strtolower(SRM_DEFAULT_NAME)); ?> Location:</div>
                            <div class="right">
                        ...
                        <div class="form-row">
                            <div class="left"><?php echo ucwords(strtolower(SRM_DEFAULT_NAME)); ?> Spots Left</div>
                ...
                <fieldset class="two-col-right">
                    ...
                    <input type="checkbox" name="agreement" id="srm-agreement" class="required" value="1" /> I agree to the <a href="<?php bloginfo('url');?>/<?php echo SRM_DEFAULT_TERMS_PAGE; ?>/" target="_blank">‎terms of registration</a>.
        ...
        <div class="srm-seminars">
            <div class="srm-register srm-form">
                <form action="" method="post">
                    <div class="form-row">
                        <div class="left">
                            Available <?php echo ucwords(strtolower(SRM_DEFAULT_NAME)); ?>s
                        </div>
                        <div class="right">
