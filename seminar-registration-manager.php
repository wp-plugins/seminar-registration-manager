...
function srm_add_menu(){
    $page = add_menu_page( 'Manage Seminars','Seminars','manage_options','seminar-registration-manager','seminar_registration_manager', plugin_dir_url( __FILE__ ).'/images/srm_icon.png' );
    add_submenu_page( 'seminar-registration-manager', 'Create New Seminar', 'Add/Edit Seminars', 'manage_options', 'srm-seminars-add-edit', 'srm_seminar_add_edit' );
