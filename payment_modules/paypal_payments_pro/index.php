...
function PPHttpPost($methodName_, $nvpStr_) {
    ...
    $API_UserName = urlencode(SRM_PAYPAL_PAYMENTS_PRO_USERNAME);
    $API_Password = urlencode(SRM_PAYPAL_PAYMENTS_PRO_PASSWORD);
    $API_Signature = urlencode(SRM_PAYPAL_PAYMENTS_PRO_SIGNATURE);
